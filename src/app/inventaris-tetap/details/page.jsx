...
const inventoryData = [
  { no: 'G.A/L/RII/Me005', gedung: '06/30/2022', lantai: 'lt3', ruang: 'A3', name: 'Meja Belajar', merk: 'Ikea', year: 2022, status: 'Baik', estimasi: 'Rp.500'},
  { no: 'G.A/L/RII/Me006', gedung: '06/30/2022', lantai: 'lt3', ruang: 'A3', name: 'Meja Belajar', merk: 'Ikea', year: 2022, status: 'Baik', estimasi: 'Rp.500'},
  { no: 'G.A/L/RII/Me007', gedung: '06/30/2022', lantai: 'lt3', ruang: 'A3', name: 'Meja Belajar', merk: 'Ikea', year: 2022, status: 'Baik', estimasi: 'Rp.500'},
  { no: 'G.A/L/RII/Me008', gedung: '06/30/2022', lantai: 'lt3', ruang: 'A3', name: 'Meja Belajar', merk: 'Ikea', year: 2022, status: 'Baik', estimasi: 'Rp.500'},
  // Tambahkan data lainnya sesuai kebutuhan
];

export default function InventarisTetapDetails() {
        ...
        <Table sx={{ minWidth: 650 }} aria-label="inventory table">
          <TableHead>
            <TableRow sx={{ backgroundColor: theme.palette.grey[100] }}>
              ...
              <TableCell sx={{ fontWeight: 'bold' }}>gedung</TableCell>
              <TableCell sx={{ fontWeight: 'bold' }}>lantai</TableCell>
              <TableCell sx={{ fontWeight: 'bold' }}>ruang</TableCell>
              ...
              <TableCell sx={{ fontWeight: 'bold' }}>Estimasi</TableCell>
