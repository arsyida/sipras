// src/app/inventaris/tidak-tetap/page.jsx
"use client";
...
// --- DATA DUMMY UNTUK INVENTARIS TIDAK TETAP ---
...
/**
 * Halaman ini menampilkan daftar inventaris Tipe 'Tidak Tetap'.
 ...
 */
export default function InventarisTidakTetapPage({ filters = {} }) {
  ...
  const handleDeleteConfirmed = (formData) => {
    console.log(`Menghapus item ${dataToDelete?.id} (tidak tetap) dengan informasi:`, formData);
  ...
  return (
    <Box>
      <ReusableTable
        columns={columns}
        data={filteredData}
        ariaLabel={`Tabel Inventaris Tidak Tetap`}
