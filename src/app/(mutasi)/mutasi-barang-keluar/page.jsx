// src/app/mutasi/mutasi-barang-keluar/page.jsx
"use client";
...
/**
 * Halaman ini menampilkan daftar barang keluar.
 ...
 */
export default function MutasiBarangKeluarPage({ filters = {} }) {
  ...
  const handleDeleteConfirmed = (formData) => {
    console.log(`Menghapus item ${dataToDelete?.id} (barang keluar) dengan informasi:`, formData);
